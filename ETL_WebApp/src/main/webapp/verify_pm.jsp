...
<head>
    <meta charset="UTF-8">
    <title>Verify Preventive Maintenance</title>
...
<div class="container mt-4">
    <h3 class="text-primary mb-4">PMs Awaiting Verification</h3>
    ...
    <table class="table table-bordered table-hover">
        ...
        <% if (pmList != null && !pmList.isEmpty()) {
            for (PMRecord r : pmList) { %>
                <tr>
                    ...
                    <td><%= r.getDoneBy() %></td>
                    <td>
                        <form action="verifyPM" method="post">
        ...
        <% }} else { %>
            <tr><td colspan="11" class="text-center text-muted">No PMs pending verification.</td></tr>
        <% } %>
        </tbody>
    </table>
